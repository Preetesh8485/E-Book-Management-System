...
import { deleteBook, fetchAllBooks, resetBookSlice } from "../store/slices/bookSlice";
...
import { requestBook, resetRequestSlice } from "../store/slices/requestSlice";
import {
  addToWishlist,
  resetWishlistSlice,
...
const BookManagement = () => {
  ...
  }, [requestMessage, requestError, dispatch]);
  ...
  }, [dispatch, wishlistMessage, wishlistError]);
                    ...
                    <tr key={book._id} className="hover:bg-gray-50/50 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <img
                            src={book.image?.url || "https://via.placeholder.com/50x70?text=Book"}
                            alt={book.title}
                            className="w-13 h-17 sm:w-12 sm:h-16 md:w-14 md:h-20 object-cover rounded-lg border border-gray-200 shadow-sm"
                          />
                      ...
                      {isAuthenticated &&
                        ...
                        book.quantity > 0 && (
                          ...
                          <td className="px-6 py-4">
                            ...
                            <button
                              onClick={async () => {
                                setRequestingBookId(book._id);

                                await dispatch(requestBook(book._id));
                              ...
                              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all ${!book.availability ||
                                requestingBookId === book._id
                                ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                                : "bg-[#00A7E1] hover:bg-[#0086b6] text-white"
                                }`}
                            >
                              {requestingBookId === book._id ? "Requesting..." : "Request Book"}
                            </button>
